  ...
  return (
    <div>
      <section id="mission">
        ...
        <p>
          At Hoppi Space, we believe that every individual should be able to pursue their artistic vision without a lack of space holding them back. Our goal is to transform the traditional avenues of searching for art-friendly venues to be more convenient for today's creative. 
          ...
          <div className="team-member-card">
            <div className="team-img" />
              <div className="team-bio">
                ...
                She strives to help create a diverse, global community of creators and bring all telephone pole "Wanted" adds to the digital realm. She's got your back, and our backend.</p>
              </div>
          </div>
      </section>
    </div>
